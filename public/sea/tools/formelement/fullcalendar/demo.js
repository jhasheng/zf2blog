					...
					$(this).fullCalendar(
							{
								...
								droppable : true, // this allows things to be
													...
													// !!!
								drop : function(date, allDay) { // this function
																// is called
																// when
																// something is
																// dropped

									// retrieve the dropped element's stored
									// Event Object
									var originalEventObject = $(this).data(
											'eventObject');

									// we need to copy it, so that multiple
									// events don't have a reference to the same
									// object
									...
									// is the "remove after drop" checkbox
									// checked?
