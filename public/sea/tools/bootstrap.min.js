...
+function($) {
	...
	Modal.prototype.show = function(_relatedTarget) {
		...
		this.backdrop(function() {
			...
			transition ? that.$element.find('.modal-dialog').one($.support.transition.end, function() { that.$element.focus().trigger(e);
...
+function($) {
	...
	$.fn.popover = function(option) {
		return this.each(function() {
			var $this = $(this);
			var data = $this.data('bs.popover'); // $this.data('bs.popover')
			var options = typeof option == 'object' && option;
...
+function($) {
	...
	ScrollSpy.prototype.refresh = function() {
		...
		this.$body.find(this.selector).map(function() {
				...
				return ($href && $href.length && $href.is(':visible') && [[$href[offsetMethod]().top + (!$.isWindow(self.$scrollElement.get(0)) && self.$scrollElement.scrollTop()), href]]) || null }).sort(function(a, b) {
							return a[0] - b[0];
						}).each(function() {
