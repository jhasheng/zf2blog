        ...
        _init: function() {
            var that    = this,
                options = {
                    ...
                    messageTag:		this.$form.attr('data-bv-messagetag'),
        ...
        _parseOptions: function($field) {
            ...
            for (var v in $.fn.bootstrapValidator.validators) {
                ...
                if ((html5AttrMap && enabled !== 'false') || (html5AttrMap !== true && ('' === enabled || 'true' === enabled || attrName === enabled.toLowerCase()))) {
                    ...
                    for (var html5AttrName in validator.html5Attributes) {
            ...
            var opts = {
                    ...
                    messageTag:	   $field.attr('data-bv-messagetag'),
